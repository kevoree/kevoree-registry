 ...
 */
public class RemoveMemberNSHandler extends AbstractHandler {

    private static final Logger log = LoggerFactory.getLogger(RemoveMemberNSHandler.class.getSimpleName());

    public RemoveMemberNSHandler(Context context) {
        super(context, true);
    }
