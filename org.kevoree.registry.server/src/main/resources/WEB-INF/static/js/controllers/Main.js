...
angular.module('kevoreeRegistry')
    .controller('Main', ['$scope', '$filter', 'registryFactory', 'userFactory',
        function ($scope, $filter, registryFactory, userFactory) {
            $scope.version = null;
            $scope.user = null;
            $scope.isCollapsed = true;

            registryFactory.getVersion()
            ...
            $scope.genGravatar = function (email, size) {
                if (email) {
                    ...
                    return 'http://www.gravatar.com/avatar/' + MD5(email) + '.jpg?s=' + (size || 50);
                }
            };
