...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "kevoree_registry@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "kevoree_registry API";

        private String description = "kevoree_registry API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "kevoree_registry";
