(function () {
  ...
  stateHandler.$inject = ['$rootScope', '$translate', 'Language', 'translationHandler', '$window', 'Auth', 'Principal'];

  function stateHandler($rootScope, $translate, Language, translationHandler, $window, Auth, Principal) {
    return {
