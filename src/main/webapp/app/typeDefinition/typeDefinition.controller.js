...
TypeDefinitionController.$inject = ['$q', '$rootScope', '$state', '$stateParams', 'paginationConstants', 'TypeDefinitions', 'Principal'];

function TypeDefinitionController($q, $rootScope, $state, $stateParams, paginationConstants, TypeDefinitions, Principal) {
	var vm = this;
	vm.page = null;
