		...
		$stateProvider
			...
			.state('namespaces.new', {
				...
				onEnter: ['$stateParams', '$state', '$uibModal', function ($stateParams, $state, $uibModal) {
					$uibModal.open({
						templateUrl: 'scripts/app/namespace/namespace-new.html',
			...
			.state('namespaces.delete', {
				...
				onEnter: ['$stateParams', '$state', '$uibModal', function ($stateParams, $state, $uibModal) {
					$uibModal.open({
						templateUrl: 'scripts/app/namespace/namespace-delete.html',
				...
				onEnter: ['$q', '$stateParams', '$state', '$uibModal', 'Principal', 'Namespace', 'AlertService', function ($q, $stateParams, $state, $uibModal, Principal, Namespace, AlertService) {
					$q.all([
						...
						if (namespace.owner !== user.login) {
							...
							$uibModal.open({
								templateUrl: 'scripts/app/namespace/namespace-add-member.html',
			...
			.state('namespaces.detail.remove-member', {
				...
				onEnter: ['$stateParams', '$state', '$uibModal', function ($stateParams, $state, $uibModal) {
					$uibModal.open({
						templateUrl: 'scripts/app/namespace/namespace-remove-member.html',
